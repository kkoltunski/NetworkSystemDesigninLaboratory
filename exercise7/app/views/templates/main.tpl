		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="active"><a href="{$conf->action_url}calcShow">Calculator</a></li>
					<li class="active"><a href="{$conf->action_url}resultsList">History</a></li>
					<li><a class="btn" href="{$conf->action_url}logout">LOG IN / LOG OUT</a></li>
				</ul>
			</div>
			<!--/.nav-collapse -->
		</div>
			...
			<div class="row">
				...
				<div class="col-md-6 widget">
					<div class="widget-body">
						<p class="simplenav">
							<a href="#">Top page</a> | 
							<b><a href="{$conf->action_url}calcShow">Calculator</a></b> | 
							<b><a href="{$conf->action_url}resultsList">History</a></b> | 
							<b><a href="{$conf->action_url}logout">LOG IN / LOG OUT</a></b>
						</p>
					</div>
				</div>
